...
fn readme_tracks_hypothesis_closure_requirements() {
    assert_contains_all(
        ...
        &[
            ...
            "P1 aggregate recomputation artifact gate, bounded ACVP/FIPS204 sample-vector provider conformance, a fixture-backed bridge evidence package with fixture-backed bridge conformance evidence, a selected-backend aggregate-output artifact gate, real standard-provider aggregate-output package evidence, a selected-backend threshold-output artifact gate, selected-backend proof-closure artifact package gate, and real-threshold backend emission ingestion artifact are present",
            "ordinary single-key standard-provider output",
            "real threshold backend emissions",
...
fn blocker_evidence_docs_keep_claim_boundary() {
    ...
    assert_contains_all(
        ...
        &[
            ...
            "real_threshold_backend_emission_artifact_fixture_parses_and_feeds_ingestion_gate",
