...
fn readme_tracks_hypothesis_closure_requirements() {
    assert_contains_all(
        ...
        &[
            ...
            "P1 aggregate recomputation artifact gate, bounded ACVP/FIPS204 sample-vector provider conformance, a fixture-backed bridge evidence package with fixture-backed bridge conformance evidence, and a selected-backend aggregate-output artifact gate are present",
...
fn blocker_evidence_docs_keep_claim_boundary() {
    ...
    assert_contains_all(
        ...
        &[
            ...
            "Evidence gates, sample-vector provider conformance, fixture-backed bridge conformance evidence, selected-backend aggregate-output artifact gate coverage, and closure frameworks only",
    ...
    assert_contains_all(
        ...
        &[
            ...
            "not FIPS validation",
            "not a completed standard-verifier compatibility proof",
            "Real selected-backend aggregate outputs",
        ],
    );
    assert_contains_all(
        "script_tests/test_assess_lattice_hypothesis.py",
