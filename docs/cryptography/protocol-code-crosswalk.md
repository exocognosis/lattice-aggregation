...
contract. These are gate and conformance tests only; they are not a real
ML-DSA verifier, threshold proof, side-channel audit, FIPS validation, or
release approval.
