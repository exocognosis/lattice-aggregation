...
| --- | --- | --- | --- | --- |
| Mask distribution (`epsilon_mask`) | `src/production/mask_distribution.rs`, `tests/production_mask_distribution.rs`, [criterion-1-proof-substance.md](../cryptography/criterion-1-proof-substance.md), [mask-distribution-evidence.md](../cryptography/mask-distribution-evidence.md), [phase-1-noise-bound-model.md](../cryptography/phase-1-noise-bound-model.md); evidence gates present and proof payload formalized | `partially_met` | Renyi-divergence bound on aggregate-vs-centralized mask distance | Aim 1 |
